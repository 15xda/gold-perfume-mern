                    ...
                    <div className="product-grid">
                        {[
                            
                            {
                                ...
                                description: 'Ароматы для бытовой химии, создающие ощущение чистоты, уюта и заботы.',
                                features: ['Освежители воздуха и ткани', 'Ароматы для чистящих средств', 'Маскировка неприятных запахов']
                            },
                            {
                                title: 'Изысканные ароматы',
                                image: "/images/pages/givaudan/4.png",
                                description: 'Уникальные ароматы, создающие эмоциональные связи и подчеркивающие индивидуальность бренда.',
                                features: ['Эмоциональное воздействие', 'Молекулярные инновации', 'Партнёрство с люксовыми брендами']
                            },
                            {
                                title: 'Благополучие и уход за собой',
                                image: "/images/pages/givaudan/5.png",
                                description: 'Комплексные решения для создания продуктов, улучшающих настроение, расслабление и общее самочувствие.',
                                features: ['Платформа Well&Be', 'Эфирные масла и нейроароматы', 'Научно обоснованные ароматы']
                            }
                        ].map((product, index) => (
                            <motion.div
